...
!function(t,n,e){"use strict";"function"==typeof define&&define.amd?define(e):"undefined"!=typeof module&&module.exports?module.exports=e():n[t]=e(t,n)}("PubSub",this,function(t,n){"use strict";var e=(n||{})[t];function r(t,n,e){var o;for(o in t)if(Object.prototype.hasOwnProperty.call(t,o)&&n&&!1===n.call(e,t[o],o,t))return;return t}function i(t,n,e){for(var o,r,i=t._pubsub_topics,u=i[n]?i[n].slice(0):[],s=0,c=u.length;s<c;s+=1){if(r=u[s].token,o=u[s],t._options.immediateExceptions)o.callback(e,{name:n,token:r});else try{o.callback(e,{name:n,token:r})}catch(t){setTimeout(function(){throw t},0)}!0===o.once&&t.unsubscribe(r)}}function o(t){var n=Array.prototype.slice.call(t,1);return n.length<=1?n[0]:n}function u(t,n,e,o){return!!t._pubsub_topics[n]&&(o?i(t,n,e):setTimeout(function(){i(t,n,e)},0),!0)}function s(t){return t=function(t){var n,e,o,r;if(null==t)throw new TypeError("Cannot convert undefined or null to object");for(n=Object(t),e=1;e<arguments.length;e++)if(null!=(o=arguments[e]))for(r in o)Object.prototype.hasOwnProperty.call(o,r)&&(n[r]=o[r]);return n}({},{immediateExceptions:!1},t),this instanceof s?(this._pubsub_topics={},this._pubsub_uid=-1,this._options=t,this):new s(t)}return s.prototype.subscribe=function(t,n,e){var o=this._pubsub_topics,r=this._pubsub_uid+=1,i={};if("function"!=typeof n)throw new TypeError("When subscribing for an event, a callback function must be defined.");return o[t]||(o[t]=[]),i.token=r,i.callback=n,i.once=!!e,o[t].push(i),r},s.prototype.subscribeOnce=function(t,n){return this.subscribe(t,n,!0)},s.prototype.publish=function(t){return u(this,t,o(arguments),!1)},s.prototype.publishSync=function(t){return u(this,t,o(arguments),!0)},s.prototype.unsubscribe=function(t){var n,e,o=this._pubsub_topics,r=!1;for(n in o)if(Object.prototype.hasOwnProperty.call(o,n)&&o[n]){for(e=o[n].length;e;){if(e-=1,o[n][e].token===t)return o[n].splice(e,1),0===o[n].length&&delete o[n],t;n===t&&(o[n].splice(e,1),0===o[n].length&&delete o[n],r=!0)}if(!0===r)return t}return!1},s.prototype.unsubscribeAll=function(){return this._pubsub_topics={},this},s.prototype.hasSubscribers=function(t){var n=this._pubsub_topics,e=!1;return null==t?(r(n,function(t,n){if(n)return!(e=!0)}),e):Object.prototype.hasOwnProperty.call(n,t)},s.prototype.subscribers=function(){var e={};return r(this._pubsub_topics,function(t,n){e[n]=t.slice(0)}),e},s.prototype.subscribersByTopic=function(t){return this._pubsub_topics[t]?this._pubsub_topics[t].slice(0):[]},s.prototype.alias=function(o){return r(o,function(t,n){var e;s.prototype[n]&&(s.prototype[o[n]]=(e=n,function(){return this[e].apply(this,arguments)}))}),this},s.noConflict=function(){return n&&(n[t]=e),s},s});
